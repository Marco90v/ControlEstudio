                        ...
                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead className="bg-gray-200 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th scope="col" className="px-6 py-3 text-start font-bold text-xs text-gray-500 uppercase dark:text-gray-400">Editar</th>
                                    <th scope="col" className="px-6 py-3 text-end font-bold text-xs text-gray-500 uppercase dark:text-gray-400">Eliminar</th>
                                </tr>
                            </thead>
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                {
                                    data && data.map((item:classe)=>{
                                        return(
                                            <tr className="hover:bg-gray-200 odd:bg-gray-100 transition-all duration-300" key={item.id}>
                                                <td className="px-4 py-2 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">{item.names}</td>
